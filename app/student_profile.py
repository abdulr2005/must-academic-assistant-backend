...
def extract_short_onboarding_reply(text: str, profile: dict) -> dict:
    """Parse only the next missing field without invoking a model."""
    from .nlp.profile import parse_onboarding
    return parse_onboarding(text, profile)
